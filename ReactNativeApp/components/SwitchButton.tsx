...
import { Animated, ImageSourcePropType, ImageStyle, StyleProp, TextStyle, View, ViewStyle } from "react-native";
/**
 * ? Local Imports
 */
  ...
  renderText = () => {
    ...
    return (
      !this.props.disableText && (
        <Animated.View style={[styles.textContainerStyle, textContainerStyle]}>
          <Animated.Text style={{ ...textStyle, color: animatedTextColor }}>{text}</Animated.Text>
        </Animated.View>
      )
    );
  };
